...
export const getAllTutors = async (req: any, res: any) => {
    try {
...
export const getTutorInfoById = async (req: any, res: any) => {
    try {
...
export const generateStudenntSummary = async (req: any, res: any) => {
    try {
